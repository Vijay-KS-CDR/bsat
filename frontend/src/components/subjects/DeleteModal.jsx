...
const DeleteModal = ({ isOpen, onClose, onConfirm, subjectName }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-bold text-[#0F172A]">Delete Subject Record</h3>
              <p className="text-sm text-[#64748B] mt-2 leading-relaxed">
                Are you sure you want to delete <strong className="text-[#0F172A]">{subjectName || 'this subject'}</strong>? This action cannot be undone and will permanently remove this subject syllabus structure and associated records.
              </p>
            </div>
          </div>
